...
import com.example.chatten.databinding.DeleteDialogBinding;
import com.example.chatten.databinding.ItemReceiveGroupBinding;
import com.example.chatten.databinding.ItemSentGroupBinding;
...
public class GroupMessagesAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        Message message = messages.get(position);
        int reactions[]=new int[]{                  //Code for connecting feelings in app
